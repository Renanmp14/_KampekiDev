// Núcleo de cálculo das recorrências (custos fixos). Funções PURAS: não tocam na
// planilha, não conhecem Express nem React, e não leem o relógio — a data de
// "hoje" sempre entra por parâmetro. É o que permite exercitá-las direto no Node.
//
// ⚠ ESPELHO: `frontend/src/utils/recorrentesCalc.js` carrega a mesma lógica. O
// calendário precisa projetar as ocorrências futuras sem uma ida ao servidor a
// cada troca de mês, e o backend não pode importar de `frontend/src` (essa pasta
// não é empacotada junto do backend no Electron). Mudou aqui, muda lá — existe um
// teste de paridade que roda a mesma bateria nos dois e exige resultado idêntico.
//
// Datas trafegam como string `DD/MM/YYYY`, como no resto do app. Toda comparação
// é feita POR VALOR (via UTC), nunca lexicograficamente — "02/01/2026" é menor
// que "10/12/2025" como texto, e isso arruinaria qualquer intervalo.
